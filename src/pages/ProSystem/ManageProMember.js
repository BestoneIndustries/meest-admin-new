...
export default function ManageProMember() {
  function myFunction() {
                ...
                <div className="col-12">
                  <div className="card">
                    <div className="card-header border-bottom">
                      <div className="col-12">
                        <h4 className="card-title">Manage Pro Memebers</h4>
                        <a href="#" className="btn btn-danger shadow mt-1">
                            ...
                            >
                              <thead className="thead-light">
                                <tr>
                                  ...
                                  <th data-field="symbol" data-editable="true">
                                    Country
                                  </th>
                                  <th
                                    data-field="pro-type"
