...
export default function Videos() {
  ...
  const loadPosts = async (pgNum, pgSize) => {
    ...
    console.log("Videos Data ---->", data.data.rows); // the main data
    const resData = data.data.rows.filter((ele) => ele.posts[0].video === 1);
    SetPosts(resData);
  };
    ...
    <>
                ...
                <div className="col-lg-4 col-md-6 col-12">
                  <div className="card">
                    <div className="card-header align-items-start pb-0">
                      ...
                      <div className="col-8 ml-0">
                        <h2 className="text-bold-700 mb-25">5</h2>
                  ...
                  <div className="card">
                    <Link to="/trending-videos">
                      <div className="card-header align-items-start pb-0">
                        ...
                        <div className="col-8 ml-0">
                          <h2 className="text-bold-700 mb-25">...</h2>
                          <p className="mb-1">Trending Videos</p>
                        </div>{" "}
                      </div>
                    </Link>
                  </div>
                ...
                <div className="col-12">
                  <div className="card">
                    <div className="card-header border-bottom">
                      <div className="col-12">
                        <h4 className="card-title">Manage & Edit Videos</h4>
                      </div>
                    </div>
      ...
      >
        ...
        >
          <div className="modal-content">
            <div className="modal-body">
              Are you sure you want to delete this user's post?
            </div>
