...
export default function ManageReplies() {
  function myFunction() {
              ...
              <div className="row breadcrumbs-top">
                <div className="breadcrumb-wrapper col-12">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">Forums</li>
                    <li className="breadcrumb-item active">Manage Replies</li>
                  </ol>
                </div>
              </div>
            </div>
                ...
                <div className="col-12">
                  <div className="card">
                    <div className="card-header border-bottom">
                      <div className="col-12">
                        <h4 className="card-title">Manage Replies</h4>
                      </div>
                    </div>
