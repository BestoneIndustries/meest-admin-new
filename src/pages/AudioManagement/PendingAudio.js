...
export default function PendingAudio() {
              ...
              <div className="row breadcrumbs-top">
                <div className="breadcrumb-wrapper col-12">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">Audios</li>
                    <li className="breadcrumb-item active">Audios Details</li>
                  </ol>
                </div>
              </div>
            </div>
              ...
              <div className="card">
                <div className="card-header border-bottom">
                  <div className="col-12">
                    <h4 className="card-title">Audios</h4>
                  </div>
                  ...
                  <div className="profile-details">
                    <div>
                      <img
                        ...
                        src={userResponse.displayPicture}
                        alt=""
                      />
                    </div>
                    <div className="pl-2">
                      <h4>@{userResponse.username}</h4>
                    </div>
                  </div>
                  <div className="row">
                    {videoResponse && videoResponse.map((ele, index) => {
                      return <div className="col-md-4">
                        <div className="video-section">
                          <audio className="audio-control" controls>
                            <source src={ele.audioURL} type="audio/ogg" />
