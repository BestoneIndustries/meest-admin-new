...
export default function ManageReport() {
  ...
  const [commentsReport, setCommentsReport] = useState([]);
  ...
  async function fetchData(pgN, pgS) {
    ...
    if (resData && resData.code == 1) {
      ...
      // else
      // setPageAnchor([])
      setCommentsReport(resData.data.rows);
    }
    console.log("Comment Report ->", resData);
  }
                ...
                <div className="col-12">
                  <div className="card">
                    <div className="card-header border-bottom">
                      <div className="col-12">
                        <h4 className="card-title">Manage Report Comments</h4>
                      </div>
                    </div>
                            ...
                            >
                              <thead className="thead-light">
                                <tr>
                                  ...
                                  <th data-field="ttext" data-editable="true">
                                    Reported text
                                  </th>
