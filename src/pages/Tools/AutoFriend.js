...
export default function AutoFriend() {
  return (
    <>
              ...
              <div className="row breadcrumbs-top">
                <div className="breadcrumb-wrapper col-12">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active">Auto Friend</li>
                  </ol>
                </div>
              </div>
            </div>
                    ...
                    <div className="col-12">
                      <div className="card">
                        <div className="card-header border-bottom">
                          <div className="col-12">
                            <h4 className="card-title">Auto Friend</h4>
                            <p className="mt-1 mb-0">
                              When a user creates a new account, choose which
                              users you would like to get auto friended /
                              followed.
                            </p>
                          </div>
                        </div>
                            ...
                            <div className="api-key-wrapper">
                              <form>
                                <div id="" className="form-group">
                                  <input
                                    type="text"
                                    placeholder="Username(s), sperated by a comma (,)"
