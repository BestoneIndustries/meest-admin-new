...
export default function AutoPageLike() {
  return (
    <>
              ...
              <div className="row breadcrumbs-top">
                <div className="breadcrumb-wrapper col-12">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active">Auto Page Like</li>
                  </ol>
                </div>
              </div>
            </div>
                    ...
                    <div className="col-12">
                      <div className="card">
                        <div className="card-header border-bottom">
                          <div className="col-12">
                            <h4 className="card-title">Auto Page Like</h4>
                            <p className="mt-1 mb-0">
                              When a user creates a new account, choose which
                              page you would like to get auto like.
                            </p>
                          </div>
                        </div>
                            ...
                            <div className="api-key-wrapper">
                              <form>
                                <div id="" className="form-group">
                                  <input
                                    type="text"
                                    placeholder="page name(s), sperated by a comma (,)"
