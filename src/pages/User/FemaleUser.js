...
export default function FemaleUser() {
...
//   }
  ...
  const getAllUsers = async (pgN, pgS) => {
    ...
    if (resData) {
      ...
      setPageAnchor(pgC);
      setTableData(resData.data.totalFemale);
    }
  };
              ...
              <div className="row breadcrumbs-top">
                <div className="breadcrumb-wrapper col-12">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active">Females</li>
                  </ol>
                </div>
              </div>
            </div>
              ...
              <div className="row" id="table-hover-row">
                <div className="col-12">
                  <div className="card">
                    <div className="card-header border-bottom">
                      <div className="col-12">
                        <h4 className="card-title">All Female users</h4>
                      </div>
                    </div>
